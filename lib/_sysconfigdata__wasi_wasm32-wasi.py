...
build_time_vars = {
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14' _PYTHON_PROJECT_BASE=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/`cat pybuilddir.txt`) /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14' _PYTHON_PROJECT_BASE=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/`cat pybuilddir.txt`) /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python -m test",
